...
const OurMission = () => {
  return (
    <section className="lg:px-20 md:px-7 px-2 text-black flex flex-row max-[1210px]:flex-col max-[1210px]:gap-5 justify-between max-[852px]:items-start items-center">
